def load_file(filename: str = "level3/input.1"):
    with open(filename, "r") as file:
        ...
        return max_parking_spots, prices, tickets
    
def calc_income(max_parking_spots:int, prices:list[int], tickets:list[int])-> int:
    income = 0
...
if __name__ == "__main__":
    for input in range(1,5):
        max_parking_spots, prices, tickets = load_file(f"level3/input.{input}")
        print(calc_income(max_parking_spots, prices, tickets))